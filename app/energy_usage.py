...
def get_account_api_key(session_key: str, account_name: str):
    cfm = conf_manager.ConfManager(
        session_key,
        ADDON_NAME,
        realm=f"__REST_CREDENTIAL__#{ADDON_NAME}#configs/conf-ta_equine_energy_account",
    )
    account_conf_file = cfm.get_conf("ta_equine_energy_account")
...
class Input(smi.Script):
    ...
    def get_scheme(self):
        scheme = smi.Scheme("energy_usage")
        scheme.description = "energy_usage input"
